...
import { User, LogOut, ArrowLeftRight, ChevronDown, Shield, LayoutDashboard, Network } from 'lucide-react';
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className="flex h-11 items-center gap-2.5 pl-1 pr-3 rounded-full border border-custom-border hover:border-accent bg-secondary-bg/60 hover:bg-secondary-bg transition-all cursor-pointer group"
        aria-haspopup="true"
            ...
            <div className="p-1 space-y-1">
              {isAdmin && (
                ...
                >
                  ...
                  <span>{t('common.userProfile.adminSystem', { defaultValue: 'Quản trị hệ thống' })}</span>
                </button>
              )}
